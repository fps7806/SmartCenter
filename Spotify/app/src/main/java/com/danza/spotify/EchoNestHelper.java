...
public class EchoNestHelper {
    ...
    public static void main(String[] args) throws EchoNestException {
        EchoNestHelper sse = new EchoNestHelper();

        System.out.println("Songs by Tallest Man On Earth");
        sse.searchSongsByArtist("Tallest Man On Earth", 1);

      /*  System.out.println();
        System.out.println("Songs with Tempo by Tallest Man On Earth");
        sse.searchSongsByTempo("Tallest Man On Earth", 3);

        System.out.println();
        Double tempo = sse.getTempo("Tallest Man On Earth", "Little Brother");
        if (tempo != null) {
            System.out.println("Tempo for Tallest Man On Earth, Little Brother is " + tempo);
        }

        System.out.println();
        System.out.println("Songs fastest song by Tallest Man On Earth");
        sse.searchForFastestSongsByArtist("Tallest Man On Earth", 3);*/

        System.out.println("Search songs with IDspaces");
        sse.searchSongsWithIDSpace("Tallest Man On Earth", "Sagres", 1);
        sse.stats();
